...
const RoleCard = ({
  ...
  return (
    ...
    >
      <div
        className={`${iconBg} ${iconColor} w-14 h-14 rounded-2xl flex items-center justify-center text-2xl shadow-sm group-hover:scale-110 transition-transform duration-300`}
      >
        {icon}
      </div>
      <div>
  ...
  const roles = [
    {
      title: "Patient",
      description:
        "Book appointments, access medical records, and manage your healthcare",
      icon: <LuUser />,
      iconBg: "bg-blue-50",
    ...
    },
    {
      title: "Doctor",
      description:
        "Manage patients, appointments, and provide quality healthcare",
      icon: <LuUser />,
    ...
    },
    {
      ...
      description:
        "Learn and assist under supervision while gaining experience",
      icon: <LuUser />,
      iconBg: "bg-purple-50",
  ...
  return (
    <div className="min-h-screen bg-(--color-bg) flex flex-col items-center justify-center p-6 sm:p-12">
      <div className="max-w-5xl w-full text-center mb-16">
        <h1 className="text-5xl font-bold text-(--color-text) mb-4 tracking-tight">
          Join Assnani
        </h1>
      ...
      <div className="mt-16 text-center">
        <p className="text-(--color-text-light) font-medium">
          ...
          <NavLink
            to="/login"
            className="text-blue-600 hover:text-blue-700 font-bold hover:underline underline-offset-4"
          >
            Sign in
          </NavLink>
        </p>
