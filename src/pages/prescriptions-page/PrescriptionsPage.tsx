...
function downloadPrescriptionAsImage(
  ...
  ctx.fillText(
    `(${meds.length})`,
    PADDING + ctx.measureText("Medications").width + 38,
    126,
  );
  ...
  link.download = `prescription-${prescription.id}-${prescription.diagnosis?.replace(/\s+/g, "-") || "diagnosis"}.png`;
