  ...
  const steps = [
    {
      ...
      description:
        "Your comprehensive healthcare management platform. Let's get you started with a quick tour.",
      color: "blue",
    },
    {
      icon: Calendar,
      ...
      description:
        "Search for doctors, view their availability, and book appointments instantly with just a few clicks.",
      color: "green",
    },
    {
      icon: FileText,
      ...
      description:
        "Access all your medical history, prescriptions, and lab results in one secure place.",
      color: "purple",
    },
    {
      icon: Activity,
      ...
      description:
        "Upload medical scans for AI-assisted analysis and get quick preliminary results.",
      color: "orange",
    },
  ];
    ...
    <div className=" flex items-center justify-center  p-15 ">
      <div className="w-2xl">
        <CardComp classProbs="rounded-xl py-10">
          <div
            className={`w-24 h-24 bg-${currentStep.color}-100 dark:bg-${currentStep.color}-900/30 rounded-full flex items-center justify-center mx-auto`}
          >
            <Icon
              className={`w-12 h-12 text-${currentStep.color}-600 dark:text-${currentStep.color}-400`}
              children={undefined}
            />
          </div>
          <h2 className="text-3xl   text-center w-full">{currentStep.title}</h2>
          <p className="text-lg text-(--color-text-light) text-center w-full">
