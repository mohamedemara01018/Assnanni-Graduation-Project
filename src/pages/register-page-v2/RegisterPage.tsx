...
// import RegistrationForm from "../register-page/RegistrationForm";
        ...
        <div className="flex flex-col items-center gap-4 w-full">
          <div className="text-center">
            <h1 className="text-3xl text-(--color-text)">
              Register as{" "}
              <span className="text-(--color-primary) capitalize">{role}</span>
            </h1>
            <p className=" text-(--color-text-light) mt-1">
