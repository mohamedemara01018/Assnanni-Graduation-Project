                    ...
                    <div className="flex flex-col gap-6 flex-1 lg:flex-5 ">
                        ...
                        <CardComp>
                            <div className="flex items-center justify-between gap-4 w-full">
                                ...
                                <Link to={'/'} className="text-(--color-primary) hover:text-(--color-primary-light) transition duration-200">View All</Link>
                            </div>
                            <div className=" flex flex-col gap-3 w-full">
                                <Link to={'/'} className="flex items-center justify-between gap-4 p-4 bg-(--color-bg-link)  hover:bg-(--color-bg-link-hover) rounded-md transition duration-150">
                                    <div className="flex items-center gap-4 w-full">
                                        <div className="flex items-center justify-center bg-(--color-bg-blue) text-(--color-text-blue) w-15 h-15 rounded-full max-sm:hidden overflow-hidden">
                                            <img src="https://images.pexels.com/photos/7598696/pexels-photo-7598696.jpeg" className="object-cover w-full h-full" alt="D" />
                                        </div>
                                        <div>
                                            <h3 className="text-(--color-text)">mohamed gamal</h3>
                                            <div className="flex items-center gap-4 mt-1 text-sm">
                                                <span className="text-(--color-text-light) flex items-center gap-1 text-yellow-500 "><MdOutlineStar />  4.1</span>
                                                <span className="bg-(--color-text-light) w-1 h-1 rounded-full"></span>
                                                <span className="text-(--color-text-light)">12 exp </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="text-green-500 bg-green-500/20 px-3 pb-1 rounded-2xl text-sm flex items-center">
                                ...
                                </Link> <Link to={'/'} className="flex items-center justify-between gap-4 p-4 bg-(--color-bg-link)  hover:bg-(--color-bg-link-hover) rounded-md transition duration-150">
                                    <div className="flex items-center gap-4 w-full">
                                        <div className="flex items-center justify-center bg-(--color-bg-blue) text-(--color-text-blue) w-15 h-15 rounded-full max-sm:hidden overflow-hidden">
                                            <img src="https://images.pexels.com/photos/7598696/pexels-photo-7598696.jpeg" className="object-cover w-full h-full" alt="D" />
                                        </div>
                    ...
                    <div className="flex flex-1 max-md:flex-wrap lg:flex-2 lg:flex-col gap-4 ">
                        ...
                        <CardComp>
                            ...
                            <div className="flex flex-col gap-3 items-center w-full">
                                <Link to={'/doctors'} className="flex flex-col  items-start justify-between py-1.5 px-3 rounded-lg text-(--color-text-blue) bg-(--color-bg-blue) w-full hover:shadow-sm">
                                    <h3 className="">Find a Doctor</h3>
                                    <span className="text-[12px] text-(--color-text-light)">Search and book</span>
                                </Link>
                                <Link to={'/doctors'} className="flex flex-col  items-start justify-between py-1.5 px-3 rounded-lg text-(--color-text-blue) bg-(--color-bg-blue) w-full hover:shadow-sm">
                                    <h3 className="">Upload Scan</h3>
                                    <span className="text-[12px] text-(--color-text-light)">AI-assisted analysis</span>
                                </Link>
                                <Link to={'/doctors'} className="flex flex-col  items-start justify-between py-1.5 px-3 rounded-lg text-(--color-text-blue) bg-(--color-bg-blue) w-full hover:shadow-sm">
                                    <h3 className="">My Prescriptions</h3>
                                    <span className="text-[12px] text-(--color-text-light)">View medications</span>
                                </Link>
