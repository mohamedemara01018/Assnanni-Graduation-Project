...
import { Activity, Calendar, ChevronRight, Clock, FileText, Pill, Stethoscope, TrendingUp, User } from "lucide-react";
...
function PatientPage() {
  ...
  const { data, loading, error }: DashboardState = useSelector(patientDashboardState) as DashboardState
                        ...
                        <div className="flex items-start gap-3 min-w-0">
                          ...
                          <div className="relative shrink-0">
                            <div className="w-15 h-15 rounded-full overflow-hidden" >
                              <DoctorAvatar src={String(appointment.doctorImage)} alt={appointment.doctorName} />
                            </div>
                            <span
                    ...
                    >
                      <div className="flex items-center gap-4 w-full">
                        <div className="flex items-center justify-center bg-(--color-bg-blue) text-(--color-text-blue) w-15 h-15 rounded-full max-sm:hidden overflow-hidden">
                          <DoctorAvatar src={String(doctor.imageUrl)} alt={doctor.name} />
                        </div>
                        <div>
                  ...
                  : data.recentActivities.map((activity, i) => (
                    <div key={i} className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-500">{activity.createdAt}</p>
                      </div>
                    </div>
                  ))
                }
