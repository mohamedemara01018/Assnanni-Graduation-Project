            ...
            <CardComp>
              <div className="space-y-4">
                ...
                <p className="text-(--color-text-light">
                  Renowned neurologist specializing in brain disorders and
              ...
              <div className="space-y-4  w-full">
                ...
                <div className="space-y-4 ">
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-(--color-text-light)">
                      {" "}
                      Excellent doctor! Very thorough and caring. Highly
                      recommend.
                    </p>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-center flex-wrap gap-2">
                      {Array(3)
                        ...
                        .map((_) => {
                          return (
                            <span className="text-sm py-1 px-3 rounded-lg bg-(--color-bg-link-hover)">
                              10:00
                            </span>
                          );
                        })}
