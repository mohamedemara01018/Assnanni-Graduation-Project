        ...
        <div className="w-full space-y-8">
          <div>
            ...
            <p className="text-(--color-text-light)">
              Schedule your consultation with Dr. Michael Chen{" "}
            </p>
          </div>
          ...
          {role == "patient" ? (
            <button
              disabled
              className=" w-full py-3 bg-(--color-primary) hover:bg-(--color-primary-dark) duration-150 rounded-lg cursor-pointer"
            >
              Confirm Booking
            </button>
          ) : (
            <div className="   text-center text-lg text-(--color-text)  bg-(--color-primary) hover:bg-(--color-primary-dark) duration-150 rounded-lg cursor-pointer">
              <NavLink
                to={"/register/patient-register"}
                className="  w-full h-full block text-white rounded-lg  py-3"
              >
                Register
              </NavLink>
            </div>
