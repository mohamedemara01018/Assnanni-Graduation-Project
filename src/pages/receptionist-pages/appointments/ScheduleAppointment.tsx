  ...
  return (
    <DashboardLayout pageTitle="Schedule Appointment">
      <div className="-mt-6 bg-(--color-bg) rounded-2xl min-h-screen p-8">
        ...
        {/* Title Section */}
        <div className="mb-10">
          <h1 className="text-3xl font-bold text-(--color-text) mb-2">Schedule Appointment</h1>
          <p className="text-(--color-text-light) font-medium">Book an appointment for a patient</p>
        </div>

        <div className="flex flex-col gap-8 max-w-5xl">
          {/* Select Patient Section */}
          <div className="bg-(--color-surface) p-8 rounded-2xl border border-(--color-border) shadow-sm">
            <h2 className="text-lg font-bold text-(--color-text) mb-6">Select Patient</h2>
          ...
          <div className="bg-(--color-surface) p-8 rounded-2xl border border-(--color-border) shadow-sm">
            <h2 className="text-lg font-bold text-(--color-text) mb-8">Appointment Details</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              {/* Reason for Visit */}
              <div className="md:col-span-2">
                <label className="block text-sm font-bold text-(--color-text) mb-2">Reason for Visit</label>
                <textarea
          ...
          <div className="bg-(--color-surface) p-8 rounded-2xl border border-(--color-border) shadow-sm">
            <h2 className="text-lg font-bold text-(--color-text) mb-6">Payment Method</h2>
          ...
          <div className="bg-blue-50/50 dark:bg-blue-900/10 p-8 rounded-2xl border border-blue-100 dark:border-blue-900/30">
            <h2 className="text-blue-800 dark:text-blue-400 font-bold mb-6">Appointment Summary</h2>
            <div className="space-y-3">
              <div className="flex justify-between text-sm">
                <span className="text-blue-700/70 dark:text-blue-400/70">Patient:</span>
                <span className="font-bold text-blue-900 dark:text-blue-300">Sarah Johnson</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-blue-700/70 dark:text-blue-400/70">Doctor:</span>
                <span className="font-bold text-blue-900 dark:text-blue-300">Dr. Michael Chen</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-blue-700/70 dark:text-blue-400/70">Date:</span>
                <span className="font-bold text-blue-900 dark:text-blue-300">2027-02-02</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-blue-700/70 dark:text-blue-400/70">Time:</span>
                <span className="font-bold text-blue-900 dark:text-blue-300">03:00 PM</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-blue-700/70 dark:text-blue-400/70">Payment Method:</span>
                <span className="font-bold text-blue-900 dark:text-blue-300">{formData.paymentMethod === 'cash' ? 'Cash' : 'Online Payment'}</span>
              </div>
              <div className="pt-3 mt-3 border-t border-blue-200 dark:border-blue-800 flex justify-between text-sm">
                <span className="text-blue-700 dark:text-blue-400 font-bold">Consultation Fee:</span>
                <span className="font-bold text-blue-900 dark:text-blue-300">$180</span>
              </div>
            </div>
          </div>
