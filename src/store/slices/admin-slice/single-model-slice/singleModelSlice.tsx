...
export const fetchModelById = createAsyncThunk<
  ...
  { rejectValue: string }
>("singleModel/fetchModelById", async (id, { rejectWithValue }) => {
  ...
  try {
    ...
    if (!response.ok) {
      return rejectWithValue(json?.message || "Failed to fetch model details");
    }
...
export const selectSingleModelState = (state: RootState) =>
  state.singleModelSlice;
