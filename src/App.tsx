...
// Constants & helpers
import { roleRoutePaths, sharedRoutePaths } from "./constants/routeConstants";
import { ProtectedRoute, homePageByRole, routeElements } from "./constants/appConstants";
import { logout } from "./store/slices/auth/authSlice";
...
function useSessionExpiry(token: string | null, expiresAt: number | null) {
  ...
  useEffect(() => {
    ...
    const warningDelay = Math.max(timeUntilExpiry - SESSION_WARNING_BEFORE_EXPIRY_MS, 0);
