...
export function RescheduleAppointmentModal({
    ...
    const { data: availableSlots, loading: loadingSlots, error: errorSlots } =
        useSelector(availableSlotsState) as ScheduleSlotsState;
    const { loading: submitting } =
        useSelector(rescheduleAppointmentState);
    ...
    useEffect(() => {
        return () => { dispatch(clearRescheduleState()); };
    }, [dispatch]);
                        ...
                        <div className="flex flex-col gap-5 px-7 py-5 overflow-y-auto flex-1 min-h-0">
                            ...
                            <div>
                                ...
                                {loadingDates ? (
                                    <div className="flex items-center justify-center gap-2 rounded-xl border border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-800/50 py-5">
                                        ...
                                        <span className="text-xs text-gray-400">Loading available dates…</span>
                                    </div>
                                ) : errorDates ? (
                                            ...
                                            {availableSlots.map((slot) => {
                                                ...
                                                return (
                                                    <button
                                                        ...
                                                        className={`rounded-lg border py-2 text-xs transition-all ${isSelected
                                                    ...
                                                    >
                                                        ...
                                                        <span className={`block text-[9px] mt-0.5 ${isSelected ? 'text-blue-200' : 'text-gray-400 dark:text-gray-500'}`}>
                                ...
                                <div className="flex items-center gap-3 rounded-xl border border-green-200 dark:border-green-900/50 bg-green-50 dark:bg-green-900/20 px-4 py-3 animate-in fade-in slide-in-from-bottom-1 duration-200">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-green-900 dark:text-green-300">
                                            {selectedDateParsed?.fullLabel} · {formatTime(selectedSlot.startTime)}
                                        </p>
                                    </div>
                                </div>
                            )}
                            ...
                            <div className="flex items-start gap-2 px-0.5">
                                ...
                                <p className="text-xs text-gray-400 dark:text-gray-500 leading-relaxed font-light">
                                    Rescheduling is available up to 24 hours before your appointment. A confirmation will be sent to your email once confirmed.
                                </p>
                            </div>
                        </div>
