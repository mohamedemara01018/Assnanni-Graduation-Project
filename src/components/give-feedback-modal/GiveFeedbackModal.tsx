...
interface GiveFeedbackModalProps {
    ...
    onSubmit?: (feedback: { rating: number; comment: string }) => Promise<void> | void;
}
    ...
    return (
        <div className="flex items-center gap-1">
            {[1, 2, 3, 4, 5].map((s) => (
                ...
                >
                    <Star
                        className={`w-${size} h-${size} transition-colors ${s <= active
                        ...
                        <div className="flex flex-col gap-5 px-7 py-5 overflow-y-auto flex-1 min-h-0">
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    Overall rating
                                    <span
                                        className="text-red-500 normal-case tracking-normal ml-0.5"
                                    >
                                        *
                                    </span>
                                </p>
                        ...
                        >
                            ...
                            <div className="flex gap-2">
                                ...
                                <button
                                    ...
                                    style={{
                                        backgroundColor:
                                            rating === 0 ? "var(--color-text-light)" : "var(--color-primary)",
                                    }}
                                >
                                    {submitting ? (
                                        <>
