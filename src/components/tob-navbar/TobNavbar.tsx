    ...
    return (
        <div className="wrapper flex items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-2 font-extrabold">
                ...
                <Link to={'/'} className="relative p-2  hover:bg-(--color-bg-link-hover) rounded-lg text-2xl cursor-pointer">
                ...
                <div>
                    ...
                    {/* drob down */}
                    {
                        showUserMenu && <div className='relative'>
                            <div onClick={() => setShowUserMenu(!showUserMenu)} className='fixed inset-0 z-30'></div>
