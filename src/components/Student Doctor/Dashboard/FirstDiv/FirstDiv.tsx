...
const FirstDiv = () => {
  return (
    <div className="flex-2">
      ...
      <div className="bg-gray-50 p-6 rounded-xl mt-6">
        <div className="flex justify-between mb-6 pb-3 border-b-2 border-gray-300 items-center">
          <h1 className="text-xl text-gray-800 flex gap-2 items-center">
            Patient Cases <CiLock className="text-gray-500 " />
          </h1>
          <NavLink to={"#"} className={"text-sm text-gray-500 cursor-text"}>
            View Only
          </NavLink>
        </div>
        <div className="flex flex-col gap-4 max-h-60 overflow-y-auto">
