                ...
                <ul className="p-2 py-5 space-y-1">
                    <li >
                        <NavLink to={'/patient'} className={({ isActive }) =>
                            `flex  items-center ${toggled ? 'justify-center' : ''} gap-3 text-(--color-text) px-3 py-2.5 rounded-lg hover:bg-(--color-bg-link-hover) ${isActive ? 'bg-(--color-bg-blue) text-(--color-text-blue) ' : ''}`} >
