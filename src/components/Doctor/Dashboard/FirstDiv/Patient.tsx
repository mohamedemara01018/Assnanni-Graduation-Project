  ...
  return (
    <div className="flex justify-between items-center bg-gray-200 p-4 rounded-xl">
      <div className="flex gap-4 items-center">
        <div className="flex items-center justify-center w-10 h-10 bg-linear-90 from-[#0087D5] to-[#00AE9B] rounded-full">
          <span className="text-gray-50 font-semibold text-xl h-fit">
            {firstCharacter}
          </span>
        </div>
